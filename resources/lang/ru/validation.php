...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'new_title_product' => "'наименование продукта'",
        'new_description_product' => "'описание продукта'",
        'new_price_product' => "'стоимость продукта'",
        'new_status_product' => "'статус продукта'",
        'new_viewcount_product' => "'коллчество просмотров продукта'",
        'mainImage' => "'основное изображение'",
        'category_id' => "'категория'",
        'commentName' => "'имя'",
        'newComment' => "'комментарий'",
        'bannerUrl' => "'ссылка переадресации'",
        'bannerNote' => "'заметки'",
        'commentTextEdit' => "'комментарий'",
        'commentProduct' => "'продукт'"
    ],
