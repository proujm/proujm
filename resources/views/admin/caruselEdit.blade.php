...
@section('content')
    <div class="container">
        <div class="row">
            {{--    Основной контейнер   --}}
            <div class="col-md-12">
                <h3>Редактирование баннера карусели</h3>
                <br><br>
                {{-- Ошибки --}}
                {!! Helpers::errorMsg($errors) !!}

                <form action="{{route('carusel.update', $banner->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <td>
                                ...
                                @else
                                    <a href="{{ asset('images/carusel/'.$banner->img_name) }}" class="fullScreenImage" data-lightbox="example-set" data-title="">
                                        <img src="{{ asset('images/carusel/'.$banner->img_name) }}" class="fullScreenImage caruselEditImg">
                                    </a>
                                @endif
                            </td>
                        </tr>
