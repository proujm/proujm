            ...
            <div class="col-md-9">
                @if(count($banners) == 0)
                    <div class="nullHorisontalBanners">
                        <div class="nullHorisontalBannersTitle">
                            <h3>Баннеры не созданы</h3>
                        </div>
                        <div class="nullHorisontalBannersText">
                            <h5>добавьте новый баннер</h5>
                        </div>
                    </div>
                @else
                            ...
                            <tr>
                                <td>
                                    <a href="{{ asset('images/banners/'.$banner->img_name) }}" class="fullScreenImage" data-lightbox="example-set" data-title="">
                                        <img src="{{ asset('images/banners/'.$banner->img_name) }}" class="bannerImg fullScreenImage">
                                    </a>
                                </td>
                                <td>{{mb_strimwidth($banner->redirect_url,0,30,'...')}}</td>
                                <td class="bannerNote">{{mb_strimwidth($banner->note,0,160,'...')}}</td>
                                <td>
                                    <a class="btn actionButtons" href="{{route('banner.edit', $banner->id)}}" title="Редактировать">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2" align="right">
                        <a class="btn buttonHoverColor" href="{{route('banner.create')}}" title="Добавить новый баннер">Добавить</a>
                    </div>
                </div>
            </div>
        </div>
